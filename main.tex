...
The results concerning \ws{} versus XHR long polling will not be discussed, as what the other tests highlighted remains valid in this experiment. % "we can see that what" pas bon "that which" mais si moyen de reformuler mieux.

...
The results concerning \ws{} versus XHR long polling will not be discussed, as the observations highlighted before remains valid. % "we can see that what" pas bon "that which" mais si moyen de reformuler mieux.
